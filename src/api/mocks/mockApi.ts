...
mock.onGet(`${apiUrl}/user/12`).reply(200, {
  data: {
    id: 12,
    userInfos: {
      firstName: "Karl",
...
mock.onGet(`${apiUrl}/user/12/activity`).reply(200, {
  data: {
    userId: 12,
    sessions: [
      {
...
mock.onGet(`${apiUrl}/user/12/average-sessions`).reply(200, {
  data: {
    userId: 12,
    sessions: [
      {
...
mock.onGet(`${apiUrl}/user/12/performance`).reply(200, {
  data: {
    userId: 12,
    kind: {
      1: "cardio",
